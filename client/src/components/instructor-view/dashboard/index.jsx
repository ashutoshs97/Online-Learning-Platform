 ...
 */
  ...
  import { DollarSign, Users, Star, Book } from "lucide-react";
      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {config.map((item, index) => (
            <Card
              key={index}
              className="transition-all transform rounded-xl shadow-lg hover:scale-105 hover:shadow-xl hover:bg-teal-50"
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
                  {item.label}
        ...
        <Card className="transition-all transform rounded-xl shadow-lg hover:scale-105 hover:shadow-xl hover:bg-teal-50">
          <CardHeader>
            <CardTitle>Students List</CardTitle>
          </CardHeader>
          <CardContent>
